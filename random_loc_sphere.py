...
dest_path = '/Users/eiriniklemes/Documents/ORNL/project_1/python/py_samp/spheres//'
...
for cases in range(21, 31):
    f = open(f'{part_path}sphere_loc_gens{cases:03}.part', "w")
    ...
    with open(f'{part_path}sphere_loc_gens{cases:03}.part', "r") as f:
        og_cont = f.read()
    ...
    with open(f'{dest_path}keno_spheres_loc{cases:03}.inp', "w") as dest:
